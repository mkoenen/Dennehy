...
.sf-menu a:focus, .sf-menu a:hover, .sf-menu a:active {background:'.$VAN['navi_link_bghover'].';}'.PHP_EOL; 
	   ...
	   if(isset($VAN['contact_text_color']) && $VAN['contact_text_color'] <> ''){
		 $custom_css.='#contact *,#container .blockbg1 .title p,#container .blockbg1 h2{color:'.$VAN['contact_text_color'].';}'.PHP_EOL; 
	   }
	   ...
	   if(isset($VAN['contact_input_text']) && $VAN['contact_input_text'] <> ''){
		 ...
		 $custom_css.='input:-moz-placeholder {color:'.$VAN['contact_input_text'].';}
	   ...
	   if(isset($VAN['contact_btn_text']) && $VAN['contact_btn_text'] <> ''){
		 $custom_css.='.contactform .contact-btn{color:'.$VAN['contact_btn_text'].';text-shadow:none;}'.PHP_EOL; 
	   }
   }
