...
jQuery(document).ready(function(){
	...
	function custom_page_bg(){
	    if(page_custom.val()=='Yes'){
		   jQuery('#page_custom_bgcolor').add('#page_custom_fontcolor').add('#page_full_embed').add('#page_custom_img').add('#page_bg_repeat').show();
		}else{
		   jQuery('#page_custom_bgcolor').add('#page_custom_fontcolor').add('#page_full_embed').add('#page_custom_img').add('#page_bg_repeat').hide();
		}
	}custom_page_bg();
