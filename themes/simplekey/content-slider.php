...
<section id="featured" class="flexslider">
    <ul class="slides">
	  ...
	  $slider_bgcolor=trim(strip_tags(get_post_meta($post->ID, "slider_bgcolor_value", true)));
      ...
      <li id="slider-<?php the_ID();?>">
		...
		$pad_url='';
		if($slider_bgcolor<>''){
		   $bgcolor=' style="background:'.$slider_bgcolor.'"';
		}
		if($mobile_slider_bg<>''){
		...
		?>
        <div class="slide_bg<?php echo $mobile_class;?>"<?php echo $bgcolor;?>>
